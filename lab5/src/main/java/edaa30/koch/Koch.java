...
public class Koch extends Fractal {
	...
	public void draw(TurtleGraphics turtle) {
		...
		fractalLine(turtle, super.order,length,0);
		fractalLine(turtle, super.order,length,120);
		fractalLine(turtle, super.order,length,240);
	}
